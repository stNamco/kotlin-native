...
external public actual fun Int.countOneBits(): Int
...
external private fun countLeadingZeroBits(value: Int): Int
...
external private fun countTrailingZeroBits(value: Int): Int
...
external public actual fun Long.countOneBits(): Int
...
external private fun countLeadingZeroBits(value: Long): Int
...
external private fun countTrailingZeroBits(value: Long): Int
...
public actual fun Long.takeHighestOneBit(): Long =
        if (this == 0L) 0L else 1L.shl(Long.SIZE_BITS - 1 - countLeadingZeroBits())
